        ...
        return (
            ...
            <View style={styles.mainContainer}>
                ...
                <View style={styles.secondPortion}>
                    ...
                    <Text style={{ fontSize: 12, marginLeft: 3, color: 'grey' }}>you sent an image</Text>
                </View>
    ...
    render() {
        ...
        return (
            <View >
                ...
                <View style={{ position: 'absolute', borderTopWidth: 0, backgroundColor: 'transparent', bottom: 0, borderTopColor: 'black' }}>
                    <HorizontalList />
                </View>
                <View style={{ position: 'absolute', bottom: 112, backgroundColor: 'white' }}>
                    <Text style={{ color: 'black', fontWeight: 'bold', marginLeft: 12 }}>People you may know </Text>
                </View>
            </View>
